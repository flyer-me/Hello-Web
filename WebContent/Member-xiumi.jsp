				...
				<div class="MeRightArea">
					...
					<div class="informationArea">
						...
						<div class="InforContent">
							<p class="InTitle">你正在为（1536983711@qq.com）修改密码，请选择身份验证方式：</p>
							<ol class="inforFunction">
								<li class="IFList clearfix">
									...
									<p>
										...
										<span>如果你的手机还在正常使用，请选择此方式</span>
										   ...
										   <a href="http://localhost:9527/boom/Member-xiumiphone.jsp">
											<button>立即验证</button>
										   </a>
								...
								<li class="IFList clearfix">
									...
									<a href="http://localhost:9527/boom/Member-xiumiemail.jsp">
										<button>立即验证</button>
									</a>
