	...
	<div class="area">
					...
					<ul>
						<li>
							...
							<p class="PareaE">
								...
								<span>Swisse Ultiboost Hair Skin Nails 500ml</span>
							</p>
							<p class="PareaL">
								海关监督 原装正品 温润补血 美肌养颜 抗衰老 促进皮肤弹性和去皱纹，促进发质和指甲的生长。
							</p>
						</li>
						<li>
							<p class="price">
						...
						<li>
							...
							<p class="number">
								...
								<span>库存<strong class="num">1111</strong>件</span>
							</p>
							<p class="btn">
								<a href="#">立即购买</a>
		...
		<div class="Privilege boxS textWarp w1190">
			...
			<ul>
				...
				<li>团购价: <span class="c065">¥88.00</span></li>
				<li><a href="#">团购</a></li>
			</ul>                                    
		</div>
		<!-- 相关推荐 -->
		...
		<div class="mainArea w1190 textWarp cleafix">
			...
			<div class="sidebar">
				...
				<!-- 最近浏览的商品 -->
				<div class="lately boxS">
					<h3>最近浏览的商品</h3>
					<div class="lateArea"></div>
				</div>
			</div>
			<!-- 右边主要内容 -->
