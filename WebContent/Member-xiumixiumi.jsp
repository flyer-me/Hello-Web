				...
				<div class="MeRightArea">
					...
					<div class="informationArea">
						...
						<div class="InforContent">
							...
							<div class="inforArea">
								<form action="${path }/updateMima" method="post">
									<!-- 设置用户手机号 -->
									<input type="text" name="user_phone" value="${user_phone }">
									
									<div class="inforMail">
										<span>请输入新密码：</span>
										<input type="text" name="user_pass"  value="${user_pass }" placeholder="">
									</div>
									
									<div class="inforSubmit">
										<a href="http://localhost:9527/boom/Member-xiumisuccess.jsp">确定</a>
