...
<body>
	...
	<form action="<%=path %>/phonelogin" name="loginform"  method="post">
						<p class="userPhone">
							<em></em>
							<input type="text" name="user_phone" class="W310" placeholder="请输入您的手机号/邮箱" >
						</p>
						<p class="passWord">
							<em></em>
							<input type="password" name="user_pass" class="W310" placeholder="请输入密码" >
						</p>
						<!-- 
