...
<head>
	<meta charset="UTF-8">
	<title>邮箱-修改密码-个人信息-会员中心-澳猫团</title>
						...
						<div class="InforContent">
							...
							<div class="inforArea">
								<form action="">
									...
									<div class="inforMail"><span>手机号码：</span><input type="text" placeholder="请输入手机号码"></div>
									<div class="inforGet"><button>点击获取</button></div>
									<div class="inforYzm"><span>你的验证码：</span><input type="text"></div>
									<a href="http://localhost:9527/boom/Member-xiumixiumi.jsp">
											<button>确定</button>
										   </a>
								</form>
								<div class="inforText">
